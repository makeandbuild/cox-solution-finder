var jsKeyboard = {
    ...
    init: function(elem, keyboard) {
        ...
        jsKeyboard.keyboard["numberPad"] = jsKeyboard.numberPad;
    ...
    defaultKeyboard: {
        ...
        // 1st row
               ...
               { value: "Delete", isChar: "false", onclick: "jsKeyboard.del()", buttonClass: "button button_del button_custom_dark", keyClass: "key key_del" },
        // 2nd row
               { value: 65, buttonClass: "button button_a" },{ value: 83 },{ value: 68 },{ value: 70 },
               { value: 71 },{ value: 72 },{ value: 74 },{ value: 75 },{ value: 76 },
               { value: "Enter", isChar: "false", buttonClass: "button button_enter button_custom_dark", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        // 3rd row
               { value: "abc", isChar: "false", buttonClass: "button button_smallletter button_custom_dark", onclick: "jsKeyboard.changeToSmallLetter();", keyClass: "key key_smallletter" },
               { value: 90 },{ value: 88 },{ value: 67 },{ value: 86 },{ value: 66 },{ value: 78 },
               { value: 77 },{ value: 44 },{ value: 46 },{ value: 64 },
        // 4th row
               { value: "123", isChar: "false", buttonClass: "button button_numberleft button_custom_dark", onclick: "jsKeyboard.changeToNumber();", keyClass: "key key_number" },
               ...
               { value: "DONE", isChar: "false", buttonClass: "button button_symbolsright button_custom_done", onclick: "app.submitContactModal();", keyClass: "key key_space key_custom_done"}
            ],
        smallLetter: [
        // 1st row
        ...
        // 2nd row
                ...
                { value: "Enter", isChar: "false", buttonClass: "button button_enter button_custom_dark", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        // 3rd row
                { value: "ABC", isChar: "false", buttonClass: "button button_capitalletterleft button_custom_dark", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterleft" },
        ...
        // 4th row
                { value: "ABC", isChar: "false", buttonClass: "button button_numberleft button_custom_dark", onclick: "jsKeyboard.changeToCapitalLetter();", keyClass: "key key_capitalletterleft" },
                { value: "Space", isChar: "false", buttonClass: "button button_space", onclick: "jsKeyboard.space();", keyClass: "key key_space" },
                //{ value: "#$+", isChar: "false", buttonClass: "button button_symbolsright", onclick: "jsKeyboard.changeToSymbols();", keyClass: "key key_symbols" }
                { value: "DONE", isChar: "false", buttonClass: "button button_symbolsright button_custom_done", onclick: "app.submitContactModal();", keyClass: "key key_space key_custom_done"}
            ],
    ...
    numberPad: {
        ...
        // 1st row
                ...
                { value: "CLR", isChar: "false", onclick: "jsKeyboard.clear();", buttonClass: "button", keyClass: "key key_del" },{ value: 48 },{ value: "Go", isChar: "false", buttonClass: "button", onclick: "app.queryZipCode();", keyClass: "key key_enter" },
            ]
    }
}
